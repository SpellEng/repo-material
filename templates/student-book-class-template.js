const StudentBookClassTemplate = ({ studentName, tutorName, date, time, url }) => {
    return `
    <!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>You can join your class through your dashboard here: <a href="${url}" target="_blank"
...
module.exports = StudentBookClassTemplate;
