    ...
    <div className="terms">
      <div className="inner">
        ...
        <p>
          ...
          use of SpellEng's Website, located at https://spelleng.com/.
          <br /> By accessing this website we assume you accept these terms and
          conditions. Do not continue to use SpellEng.com if you do not agree to
          take all of the terms and conditions stated on this page. <br /> The
        ...
        <div className="cookies">
          <h4>Cookies</h4>
          <p>
            We employ the use of cookies. By accessing SpellEng.com, you agreed
            to use cookies in agreement with the SpellEng's Privacy Policy. Most
        ...
        <div className="licence">
          <h4>Licence</h4>
          <p>
            Unless otherwise stated, SpellEng and/or its licensors own the
            intellectual property rights for all material on SpellEng.com. All
            intellectual property rights are reserved. You may access this from
            SpellEng.com for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>
          <div className="mustNot">
            <p>You must not:</p>
            <ul>
              <li>Republish material from SpellEng.com</li>
              <li>Sell, rent or sub-license material from SpellEng.com</li>
              <li>Reproduce, duplicate or copy material from SpellEng.com</li>
              <li>Redistribute content from SpellEng.com</li>
        ...
        <p>
          ...
          SpellEng does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of SpellEng,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, SpellEng shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website. SpellEng
        ...
        <div className="warrant">
          ...
          <ul>
            ...
            <li>
              You hereby grant SpellEng a non-exclusive license to use,
        ...
        <div className="hyperlink">
          ...
          <p>
            ...
            the visibility of the hyperlink compensates the absence of SpellEng;
            ...
            us by sending an e-mail to SpellEng. Please include your name, your
            ...
            <br /><br /> Approved organizations may hyperlink to our Website as
            follows: <br />
            By use of our corporate name
            <br />
            or By use of the uniform resource locator being linked to or
            ...
            linking party's site.
            <br /> No use of SpellEng's logo or other artwork will be allowed
          ...
          <p>
            ...
            <ul>
              ...
              <li>
                ...
                Section and elsewhere in this disclaimer: <br /> (a) are subject to the
                preceding paragraph; and <br /> (b) govern all liabilities arising under
